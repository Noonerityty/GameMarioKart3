...
#define	PIRANHA_SAFE_ZONE_X 60
#define PIRANHA_SAFE_ZONE_Y 15
#define PIRANHA_ACTIVE_ZONE_X 256
...
#define PIRANHA_BULLET_SPEED_X_NARROW 0.08f
#define PIRANHA_BULLET_SPEED_Y_NARROW 0.04f
#define PIRANHA_BULLET_SPEED_X_WIDE 0.04f
#define PIRANHA_BULLET_SPEED_Y_WIDE 0.08f
